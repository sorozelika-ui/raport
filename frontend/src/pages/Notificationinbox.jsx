...
// const TYPE_CONFIG = {
//   evaluation: { label: "Évaluation",  emoji: "📊", color: "#2563eb", bg: "#eff6ff",  border: "#bfdbfe" },
//   alerte:     { label: "Alerte",      emoji: "⚠️", color: "#dc2626", bg: "#fef2f2",  border: "#fecaca" },
//   info:       { label: "Information", emoji: "ℹ️",  color: "#059669", bg: "#f0fdf4",  border: "#bbf7d0" },
// };
...
// ══════════════════════════════════════════ */
// const NotificationInbox = ({ prestataireId = 1 }) => {
//   const [notifications, setNotifications] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [filter, setFilter] = useState("all"); // "all" | "unread" | "evaluation" | "alerte" | "info"
