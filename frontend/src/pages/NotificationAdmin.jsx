...
const TYPE_CONFIG = {
  evaluation: { label: "Résultat d'évaluation", emoji: "📊", color: "#2563eb", bg: "#eff6ff", border: "#bfdbfe" },
  alerte:     { label: "Alerte importante",      emoji: "⚠️", color: "#dc2626", bg: "#fef2f2", border: "#fecaca" },
  info:       { label: "Information générale",   emoji: "ℹ️",  color: "#059669", bg: "#f0fdf4", border: "#bbf7d0" },
};
...
const NotificationAdmin = () => {
  ...
  const loadHistorique = async () => {
    setHistLoading(true);
    try {
      const r = await axios.get(`${API}/notifications/prestataire/all`);
